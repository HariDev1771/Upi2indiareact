...
const Addtobasketpage = () => {
  return (
    <div className="pt-10 px-2 lg:p-16 lg:px-28 flex flex-col items-center gap-5">
      ...
      <div>
        <h1 className="text-xl md:text-3xl lg:text-3xl font-bold  text-[#001463]">
          2. Surprise /recipient's First Name/ with a gift amount!
        </h1>
      </div>
      <div className="flex flex-col md:flex md:justify-between gap-10 md:flex-row lg:flex lg:flex-row lg:justify-between">
        <div
          className="flex w-[278px] h-[296px] lg:min-w-[300px] lg:h-[450px] justify-center items-center text-center bg-center bg-contain bg-no-repeat "
          style={{ backgroundImage: "url('/assets/reciept-shape.jpg')" }}
        >
        ...
        <div className="flex flex-col gap-2  justify-center">
          ...
          <div className="w-[275px] md:w-[328px] lg:w-[36rem] h-28 border-2 justify-between px-6 border-gray-400 rounded-lg flex items-center mb-3">
            ...
            <div className="flex flex-col  ">
              <p className="text-xs md:text-md lg:text-xl font-bold  text-[#001463]">
                Formula Followed:
              </p>

              <p className="text-xs md:text-md font-bold text-gray-500">
                (£10.00 x ₹103.5)
              </p>
            </div>
            <p className="text-2xl lg:text-4xl  text-gray-500">₹</p>
          ...
          <div className="flex gap-40 md:gap-80 lg:gap-80">
            ...
            <div>
              {" "}
              <i className="fas fa-gift text-blue-600 text-3xl"></i>
            </div>
          </div>
        </div>
      </div>
